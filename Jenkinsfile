        ...
        stage('check stuff') {
            steps {
                script {
                    ...
                    sh 'kubectl exec -n cypress ui-app-bdf6dd845-x459q -- pwd'
                    sh 'kubectl exec -n cypress ui-app-bdf6dd845-x459q -- ls -la'
                    sh 'kubectl describe pod/e2e-test-app-job-psw5q -n cypress'
                    sh 'kubectl logs -n cypress e2e-test-app-job-psw5q -c e2e-test-app'
                }
            }
        }
